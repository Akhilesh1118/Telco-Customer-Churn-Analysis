...
![Customer Churn Distribution](Images/01_customer_churn_distribution_bar.png)

---

## 2. Customer Churn Distribution (Pie Chart)

![Customer Churn Pie](Images/02_customer_churn_distribution_pie.png)

---

## 3. Gender vs Churn Analysis

![Gender vs Churn](Images/03_gender_vs_churn_analysis.png)

---

## 4. Senior Citizen vs Churn Analysis

![Senior Citizen vs Churn](Images/04_senior_citizen_vs_churn_analysis.png)

---

## 5. Churn Percentage by Senior Citizen Category

![Senior Citizen Churn Percentage](Images/05_churn_percentage_by_senior_citizen.png)

---

## 6. Tenure Distribution by Churn Status

![Tenure Distribution](Images/06_tenure_distribution_by_churn_status.png)

---

## 7. Contract Type vs Churn Analysis

![Contract Type](Images/07_contract_type_vs_churn_analysis.png)

---

## 8. Service Features Impact on Churn

![Service Features](Images/08_service_features_impact_on_churn.png)

---

## 9. Payment Method vs Churn Analysis

![Payment Method](Images/09_payment_method_vs_churn_analysis.png)

---

## 10. Correlation Analysis Heatmap

![Correlation Heatmap](Images/10_correlation_analysis_heatmap.png)
